...
En Buenos Aires, Geikha estudia [Artes Electrónicas en **UNTREF**](https://arteselectronicas.untref.edu.ar/es/home), donde organiza talleres de live coding, así como en otras instituciones como **UBA–FCEN**, aportando al crecimiento de la escena local.

En todos estos ámbitos, Geikha define su práctica como **arte de la clase trabajadora**: experimental sin desligarse de lo popular, político sin tapujos. Su trabajo prioriza la comprensión de las masas, la reapropiación de tecnologías accesibles y una posición explícita contra el *gatekeeping*, entendiendo el live coding como un *proceso cultural colectivo* y no como una exhibición de virtuosismo individual.
{{% /es %}}
{{< /multilang >}}